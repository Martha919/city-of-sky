...
public class GuideActivity extends Activity implements ViewPager.OnPageChangeListener {
    ...
    private void initViews() {
        ...
        views.add(inflater.inflate(R.layout.page1_guide, null));
        views.add(inflater.inflate(R.layout.page2_guide, null));
        views.add(inflater.inflate(R.layout.page3_guide, null));
